...
public class RockPaperScissors {
	...
	public static void main(String[] args) {
		...
		while (option.equals("y")) {
			...
			} else if (result1.equals("剪刀") && result2.equals("布")
					|| result1.equals("石头") && result2.equals("剪刀")
					|| result1.equals("布") && result2.equals("石头")) {
			...
			if (option.equals("n")) {
				...
				if (self.score > opponent.score) {
					...
					System.out
							.println(opponent.name + "赢!" + self.name + "笨蛋!");
				}
